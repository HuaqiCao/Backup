...
def run():
    ...
    fname,ftype = QFileDialog.getOpenFileName(None, "Open File", "/mnt/d/RUNs_data_analysis/RUN2409/Converted_Data/tdms/", "TDMS file(*.tdms)")#如果添加一个内容则需要加两个分号
    ...
    print("Make a new File:"+fnewname+".BIN2")
    fileBIN2_heat = open(fnewname+".BIN2",'wb')
    num = 0
