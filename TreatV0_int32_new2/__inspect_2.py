...
def __read():
    # 文件路径和名称
    FilePath = str('/mnt/d/RUNs_data_analysis/RUN2410/Converted_Data/tdms/BKG_RUN2410_2_2/SB40_T7PID8p7mK_5kHz_bkg_4h45min_202411062138/LD/')
    FileName = str('LD.BIN2')
    ...
    startp_file = str('/mnt/d/TreatV0_int32_new/tripos/LD3300to7400.txt')
        # 读取startp列表
