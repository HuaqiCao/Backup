% select multiple CSV files containing acceleration data
% computes the Power Spectral Density (PSD) for each file using Welch's method.
% plots the PSD in both linear (g^2/Hz) and dBm/Hz formats.
