% time domain(V->g), RMS, and FFT analysis of CSV data
% all N -> Fast Fourier Transform (FFT)
...
% Convert voltage (V) → acceleration (g)
sensitivity = 1.026;   % V/g (sensor sensitivity)
