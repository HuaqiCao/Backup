...
\section{无中微子双贝塔衰变物理机制简介及研究意义}

\subsection{0$\nu\beta\beta$物理机制简介}
对 0νββ 的产生机制有多种不同的理论诠释，本节将介绍目前最为主流简洁的活性马约拉纳中微子交换机制。
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/mass_ordering_plot.png} % 修改为你的真实文件名
    \caption{有效中微子质量相对于最小中微子质量的参数空间。红色和绿色部分分别代表正质量顺序和反质量顺序，右侧灰色区域表示由于宇宙学观测对于中微子质量本征态中最小质量的限制}
