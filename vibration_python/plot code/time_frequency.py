...
def load_vibration_data(filepath):
    ...
    df = pd.read_csv(filepath, skiprows=4, header=None, delimiter=delimiter,
...
def plot_psd_multi(data_list, save_dir=None):
    ...
    ax2.set_title('Amplitude Spectral Density (ASD)', fontsize=14, fontweight='bold')
...
def main():
    ...
    for filepath in filepaths:
        try:
            ...
            freq, psd, asd = compute_psd(v, fs, nperseg=131072, overlap_ratio=0.5)
