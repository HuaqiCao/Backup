classdef QZS_App < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            y_geom_ctrl = y_geom_ctrl - 28;
            uilabel(app.RightAxesPanel, 'Position', [940 y_geom_ctrl 110 22], 'Text', 'd (mm):', 'FontWeight', 'bold');
